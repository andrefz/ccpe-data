...
16:                                               ; preds = %13
  ...
  %32 = sext i32 %31 to i64
  %33 = getelementptr inbounds float, float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 384080) to float*), i64 %32
...
49:                                               ; preds = %8
  ...
  %57 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.138, i64 0, i64 0), double %56)
  call void @check(i32 12)
  ret i32 0
}
...
51:                                               ; preds = %8
  ...
  %59 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.139, i64 0, i64 0), double %58)
  call void @check(i32 12)
  ret i32 0
}
