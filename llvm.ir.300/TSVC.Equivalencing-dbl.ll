...
define dso_local i32 @s421() #0 {
  ...
  %9 = call i32 @set1d(double* %8, double 1.000000e+00, i32 1)
...
16:                                               ; preds = %11
  %17 = load double*, double** @xx, align 8
  store double* %17, double** @yy, align 8
...
21:                                               ; preds = %18
  ...
  %33 = load double*, double** @xx, align 8
...
45:                                               ; preds = %11
  ...
  %53 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.137, i64 0, i64 0), double %52)
...
57:                                               ; preds = %54
  ...
  store double %64, double* @temp, align 8
  br label %65
...
define dso_local i32 @s1421() #0 {
  ...
  %10 = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.101, i64 0, i64 0))
  store i64 0, i64* %1, align 8
  store double* getelementptr inbounds (double, double* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 256032) to double*), i64 16000), double** @xx, align 8
  store i32 0, i32* %5, align 4
  br label %11
...
17:                                               ; preds = %34, %16
  ...
  %19 = icmp slt i32 %18, 16000
  br i1 %19, label %20, label %37

20:                                               ; preds = %17
  %21 = load double*, double** @xx, align 8
...
42:                                               ; preds = %11
  ...
  %50 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.138, i64 0, i64 0), double %49)
  store double 0.000000e+00, double* @temp, align 8
  store i32 0, i32* %7, align 4
  br label %51
...
54:                                               ; preds = %51
  %55 = load double*, double** @xx, align 8
  %56 = load i32, i32* %7, align 4
  %57 = sext i32 %56 to i64
  %58 = getelementptr inbounds double, double* %55, i64 %57
  %59 = load double, double* %58, align 8
  %60 = load double, double* @temp, align 8
  %61 = fadd double %60, %59
  store double %61, double* @temp, align 8
  br label %62
...
define dso_local i32 @s422() #0 {
  ...
  %6 = alloca i32, align 4
  %7 = alloca i32, align 4
  store double* getelementptr inbounds ([65536 x double], [65536 x double]* @array, i64 0, i64 4), double** @xx, align 8
  %8 = load double*, double** @xx, align 8
  %9 = call i32 @set1d(double* %8, double 0.000000e+00, i32 1)
...
20:                                               ; preds = %17
  ...
  %22 = add nsw i32 %21, 8
  %23 = sext i32 %22 to i64
  %24 = getelementptr inbounds [65536 x double], [65536 x double]* @array, i64 0, i64 %23
  %25 = load double, double* %24, align 8
  %26 = load i32, i32* %6, align 4
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds double, double* getelementptr inbounds (%struct.GlobalData, %struct.GlobalData* @global_data, i32 0, i32 0, i32 0), i64 %27
  %29 = load double, double* %28, align 8
  %30 = fadd double %25, %29
  %31 = load double*, double** @xx, align 8
...
43:                                               ; preds = %11
  ...
  %51 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.139, i64 0, i64 0), double %50)
  store double 0.000000e+00, double* @temp, align 8
  store i32 0, i32* %7, align 4
  br label %52
...
55:                                               ; preds = %52
  %56 = load double*, double** @xx, align 8
  %57 = load i32, i32* %7, align 4
  %58 = sext i32 %57 to i64
  %59 = getelementptr inbounds double, double* %56, i64 %58
  %60 = load double, double* %59, align 8
  %61 = load double, double* @temp, align 8
  %62 = fadd double %61, %60
  store double %62, double* @temp, align 8
  br label %63
...
define dso_local i32 @s423() #0 {
  ...
  %11 = getelementptr inbounds double, double* getelementptr inbounds ([65536 x double], [65536 x double]* @array, i64 0, i64 0), i64 %10
  store double* %11, double** @xx, align 8
  %12 = load double*, double** @xx, align 8
  %13 = call i32 @set1d(double* %12, double 1.000000e+00, i32 1)
...
21:                                               ; preds = %39, %20
  %22 = load i32, i32* %7, align 4
  %23 = icmp slt i32 %22, 31999
  br i1 %23, label %24, label %42

24:                                               ; preds = %21
  %25 = load double*, double** @xx, align 8
  %26 = load i32, i32* %7, align 4
  %27 = sext i32 %26 to i64
  ...
  %36 = add nsw i32 %35, 1
  %37 = sext i32 %36 to i64
  %38 = getelementptr inbounds [65536 x double], [65536 x double]* @array, i64 0, i64 %37
...
59:                                               ; preds = %56
  ...
  %62 = getelementptr inbounds [65536 x double], [65536 x double]* @array, i64 0, i64 %61
  %63 = load double, double* %62, align 8
  %64 = load double, double* @temp, align 8
...
define dso_local i32 @s424() #0 {
  ...
  store double* %11, double** @xx, align 8
  %12 = load double*, double** @xx, align 8
  %13 = call i32 @set1d(double* %12, double 0.000000e+00, i32 1)
...
24:                                               ; preds = %21
  ...
  %27 = getelementptr inbounds [65536 x double], [65536 x double]* @array, i64 0, i64 %26
  ...
  %34 = load double*, double** @xx, align 8
  %35 = load i32, i32* %7, align 4
  %36 = add nsw i32 %35, 1
  %37 = sext i32 %36 to i64
...
47:                                               ; preds = %15
  ...
  store double %53, double* %5, align 8
  %54 = load double, double* %5, align 8
  %55 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.141, i64 0, i64 0), double %54)
  store double 0.000000e+00, double* @temp, align 8
  store i32 0, i32* %8, align 4
  br label %56
...
59:                                               ; preds = %56
  %60 = load double*, double** @xx, align 8
  ...
  store double %66, double* @temp, align 8
  br label %67
...
define dso_local void @set(i32* %0, double* %1, double* %2) #0 {
  ...
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.142, i64 0, i64 0))
  store i32 0, i32* %7, align 4
  br label %11
...
20:                                               ; preds = %15, %2
  ...
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.143, i64 0, i64 0), i32 %21)
...
30:                                               ; preds = %25, %20
  ...
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.144, i64 0, i64 0))
  %33 = call i32 @s421()
  %34 = call i32 @s1421()
  %35 = call i32 @s422()
  %36 = call i32 @s423()
