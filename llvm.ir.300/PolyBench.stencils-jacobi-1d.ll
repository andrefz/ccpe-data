...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  ...
  %10 = call i8* @polybench_alloc_data(i64 30, i32 8)
  %11 = bitcast i8* %10 to [30 x double]*
  store [30 x double]* %11, [30 x double]** %8, align 8
  %12 = call i8* @polybench_alloc_data(i64 30, i32 8)
  %13 = bitcast i8* %12 to [30 x double]*
  store [30 x double]* %13, [30 x double]** %9, align 8
  %14 = load i32, i32* %6, align 4
  %15 = load [30 x double]*, [30 x double]** %8, align 8
  %16 = getelementptr inbounds [30 x double], [30 x double]* %15, i64 0, i64 0
  %17 = load [30 x double]*, [30 x double]** %9, align 8
  %18 = getelementptr inbounds [30 x double], [30 x double]* %17, i64 0, i64 0
  call void @init_array(i32 %14, double* %16, double* %18)
  %19 = load i32, i32* %7, align 4
  %20 = load i32, i32* %6, align 4
  %21 = load [30 x double]*, [30 x double]** %8, align 8
  %22 = getelementptr inbounds [30 x double], [30 x double]* %21, i64 0, i64 0
  %23 = load [30 x double]*, [30 x double]** %9, align 8
  %24 = getelementptr inbounds [30 x double], [30 x double]* %23, i64 0, i64 0
  call void @kernel_jacobi_1d(i32 %19, i32 %20, double* %22, double* %24)
  %25 = load i32, i32* %6, align 4
  %26 = load [30 x double]*, [30 x double]** %8, align 8
  %27 = getelementptr inbounds [30 x double], [30 x double]* %26, i64 0, i64 0
  call void @print_array(i32 %25, double* %27)
  %28 = load [30 x double]*, [30 x double]** %8, align 8
  %29 = bitcast [30 x double]* %28 to i8*
  call void @free(i8* %29) #4
  %30 = load [30 x double]*, [30 x double]** %9, align 8
  %31 = bitcast [30 x double]* %30 to i8*
  call void @free(i8* %31) #4
  ret i32 0
}

; Function Attrs: noinline nounwind uwtable
define internal void @init_array(i32 %0, double* %1, double* %2) #0 {
  %4 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_jacobi_1d(i32 %0, i32 %1, double* %2, double* %3) #0 {
