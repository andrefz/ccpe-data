...
define dso_local i32 @main() #0 {
  ...
  %25 = call noalias i8* @malloc(i64 16384) #5
  ...
  %29 = call noalias i8* @malloc(i64 16384) #5
...
32:                                               ; preds = %64, %0
  ...
  %44 = call i64 @fread(i8* %37, i64 1, i64 %42, %struct._IO_FILE* %43)
...
56:                                               ; preds = %47
  ...
  %62 = call i8* @realloc(i8* %58, i64 %61) #5
...
65:                                               ; preds = %32
  %66 = call %struct.pcre2_real_match_context_8* @pcre2_match_context_create_8(%struct.pcre2_real_general_context_8* null)
  store %struct.pcre2_real_match_context_8* %66, %struct.pcre2_real_match_context_8** %8, align 8
  %67 = call %struct.pcre2_real_jit_stack_8* @pcre2_jit_stack_create_8(i64 16384, i64 16384, %struct.pcre2_real_general_context_8* null)
  ...
  call void @pcre2_jit_stack_assign_8(%struct.pcre2_real_match_context_8* %68, %struct.pcre2_real_jit_stack_8* (i8*)* null, i8* %70)
  %71 = call %struct.pcre2_real_match_data_8* @pcre2_match_data_create_8(i32 16, %struct.pcre2_real_general_context_8* null)
  ...
  call void @replace(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.19, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.20, i64 0, i64 0), %struct.string* %4, %struct.string* %5, %struct.pcre2_real_match_context_8* %72, %struct.pcre2_real_match_data_8* %73)
...
104:                                              ; preds = %100
  ...
  call void @replace(i8* %109, i8* %114, %struct.string* %11, %struct.string* %12, %struct.pcre2_real_match_context_8* %115, %struct.pcre2_real_match_data_8* %116)
...
139:                                              ; preds = %135
  ...
  %141 = call i64* @pcre2_get_ovector_pointer_8(%struct.pcre2_real_match_data_8* %140)
  store i64* %141, i64** %20, align 8
  %142 = load i32, i32* %15, align 4
  %143 = sext i32 %142 to i64
  %144 = getelementptr inbounds [9 x i8*], [9 x i8*]* %2, i64 0, i64 %143
  %145 = load i8*, i8** %144, align 8
  %146 = call %struct.pcre2_real_code_8* @pcre2_compile_8(i8* %145, i64 -1, i32 0, i32* %16, i64* %18, %struct.pcre2_real_compile_context_8* null)
  ...
  %148 = call i32 @pcre2_jit_compile_8(%struct.pcre2_real_code_8* %147, i32 1)
  br label %149
...
149:                                              ; preds = %160, %139
  ...
  %158 = call i32 @pcre2_jit_match_8(%struct.pcre2_real_code_8* %150, i8* %152, i64 %154, i64 %155, i32 0, %struct.pcre2_real_match_data_8* %156, %struct.pcre2_real_match_context_8* %157)
...
166:                                              ; preds = %149
  ...
  call void @pcre2_code_free_8(%struct.pcre2_real_code_8* %167)
  %168 = load i32, i32* %15, align 4
  %169 = sext i32 %168 to i64
  %170 = getelementptr inbounds [9 x i8*], [9 x i8*]* %2, i64 0, i64 %169
  %171 = load i8*, i8** %170, align 8
  %172 = load i32, i32* %17, align 4
  %173 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.21, i64 0, i64 0), i8* %171, i32 %172)
  br label %174
...
177:                                              ; preds = %135
  ...
  call void @pcre2_match_context_free_8(%struct.pcre2_real_match_context_8* %178)
  %179 = load %struct.pcre2_real_jit_stack_8*, %struct.pcre2_real_jit_stack_8** %9, align 8
  call void @pcre2_jit_stack_free_8(%struct.pcre2_real_jit_stack_8* %179)
  %180 = load %struct.pcre2_real_match_data_8*, %struct.pcre2_real_match_data_8** %10, align 8
  call void @pcre2_match_data_free_8(%struct.pcre2_real_match_data_8* %180)
  ...
  %190 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.22, i64 0, i64 0), i32 %185, i32 %188, i32 %189)
  ret i32 0
}
...
declare dso_local %struct.pcre2_real_match_context_8* @pcre2_match_context_create_8(%struct.pcre2_real_general_context_8*) #3

declare dso_local %struct.pcre2_real_jit_stack_8* @pcre2_jit_stack_create_8(i64, i64, %struct.pcre2_real_general_context_8*) #3

declare dso_local void @pcre2_jit_stack_assign_8(%struct.pcre2_real_match_context_8*, %struct.pcre2_real_jit_stack_8* (i8*)*, i8*) #3

declare dso_local %struct.pcre2_real_match_data_8* @pcre2_match_data_create_8(i32, %struct.pcre2_real_general_context_8*) #3

; Function Attrs: noinline nounwind uwtable
define internal void @replace(i8* %0, i8* %1, %struct.string* %2, %struct.string* %3, %struct.pcre2_real_match_context_8* %4, %struct.pcre2_real_match_data_8* %5) #0 {
  %7 = alloca i8*, align 8
  %8 = alloca i8*, align 8
  ...
  %23 = call i64* @pcre2_get_ovector_pointer_8(%struct.pcre2_real_match_data_8* %22)
  store i64* %23, i64** %17, align 8
  %24 = load i8*, i8** %7, align 8
  %25 = call %struct.pcre2_real_code_8* @pcre2_compile_8(i8* %24, i64 -1, i32 0, i32* %13, i64* %14, %struct.pcre2_real_compile_context_8* null)
  ...
  %27 = call i32 @pcre2_jit_compile_8(%struct.pcre2_real_code_8* %26, i32 1)
  br label %28
...
28:                                               ; preds = %70, %6
  ...
  %39 = call i32 @pcre2_jit_match_8(%struct.pcre2_real_code_8* %29, i8* %32, i64 %35, i64 %36, i32 0, %struct.pcre2_real_match_data_8* %37, %struct.pcre2_real_match_context_8* %38)
...
59:                                               ; preds = %42
  ...
  %67 = call i8* @realloc(i8* %62, i64 %66) #5
...
120:                                              ; preds = %28
  ...
  call void @pcre2_code_free_8(%struct.pcre2_real_code_8* %121)
  br label %122
...
136:                                              ; preds = %122
  ...
  %144 = call i8* @realloc(i8* %139, i64 %143) #5
...
declare dso_local i64* @pcre2_get_ovector_pointer_8(%struct.pcre2_real_match_data_8*) #3

declare dso_local %struct.pcre2_real_code_8* @pcre2_compile_8(i8*, i64, i32, i32*, i64*, %struct.pcre2_real_compile_context_8*) #3

declare dso_local i32 @pcre2_jit_compile_8(%struct.pcre2_real_code_8*, i32) #3

declare dso_local i32 @pcre2_jit_match_8(%struct.pcre2_real_code_8*, i8*, i64, i64, i32, %struct.pcre2_real_match_data_8*, %struct.pcre2_real_match_context_8*) #3

declare dso_local void @pcre2_code_free_8(%struct.pcre2_real_code_8*) #3

declare dso_local i32 @printf(i8*, ...) #3

declare dso_local void @pcre2_match_context_free_8(%struct.pcre2_real_match_context_8*) #3

declare dso_local void @pcre2_jit_stack_free_8(%struct.pcre2_real_jit_stack_8*) #3

declare dso_local void @pcre2_match_data_free_8(%struct.pcre2_real_match_data_8*) #3
