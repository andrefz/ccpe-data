...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  ...
  %7 = alloca [60 x [60 x i32]]*, align 8
  store i32 0, i32* %3, align 4
  store i32 %0, i32* %4, align 4
  store i8** %1, i8*** %5, align 8
  store i32 60, i32* %6, align 4
  %8 = call i8* @polybench_alloc_data(i64 3600, i32 4)
  %9 = bitcast i8* %8 to [60 x [60 x i32]]*
  store [60 x [60 x i32]]* %9, [60 x [60 x i32]]** %7, align 8
  %10 = load i32, i32* %6, align 4
  %11 = load [60 x [60 x i32]]*, [60 x [60 x i32]]** %7, align 8
  %12 = getelementptr inbounds [60 x [60 x i32]], [60 x [60 x i32]]* %11, i64 0, i64 0
  call void @init_array(i32 %10, [60 x i32]* %12)
  %13 = load i32, i32* %6, align 4
  %14 = load [60 x [60 x i32]]*, [60 x [60 x i32]]** %7, align 8
  %15 = getelementptr inbounds [60 x [60 x i32]], [60 x [60 x i32]]* %14, i64 0, i64 0
  call void @kernel_floyd_warshall(i32 %13, [60 x i32]* %15)
  %16 = load i32, i32* %6, align 4
  %17 = load [60 x [60 x i32]]*, [60 x [60 x i32]]** %7, align 8
  %18 = getelementptr inbounds [60 x [60 x i32]], [60 x [60 x i32]]* %17, i64 0, i64 0
  call void @print_array(i32 %16, [60 x i32]* %18)
  %19 = load [60 x [60 x i32]]*, [60 x [60 x i32]]** %7, align 8
  %20 = bitcast [60 x [60 x i32]]* %19 to i8*
  call void @free(i8* %20) #4
  ret i32 0
}

; Function Attrs: noinline nounwind uwtable
define internal void @init_array(i32 %0, [60 x i32]* %1) #0 {
  %3 = alloca i32, align 4
...
16:                                               ; preds = %12
  ...
  %20 = srem i32 %19, 7
  %21 = add nsw i32 %20, 1
  %22 = load [60 x i32]*, [60 x i32]** %4, align 8
  %23 = load i32, i32* %5, align 4
  %24 = sext i32 %23 to i64
  %25 = getelementptr inbounds [60 x i32], [60 x i32]* %22, i64 %24
...
46:                                               ; preds = %40, %34, %16
  %47 = load [60 x i32]*, [60 x i32]** %4, align 8
  %48 = load i32, i32* %5, align 4
  %49 = sext i32 %48 to i64
  %50 = getelementptr inbounds [60 x i32], [60 x i32]* %47, i64 %49
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_floyd_warshall(i32 %0, [60 x i32]* %1) #0 {
  %3 = alloca i32, align 4
  %4 = alloca [60 x i32]*, align 8
  %5 = alloca i32, align 4
  %6 = alloca i32, align 4
...
22:                                               ; preds = %18
  %23 = load [60 x i32]*, [60 x i32]** %4, align 8
  %24 = load i32, i32* %5, align 4
  %25 = sext i32 %24 to i64
  %26 = getelementptr inbounds [60 x i32], [60 x i32]* %23, i64 %25
  ...
  %39 = load [60 x i32]*, [60 x i32]** %4, align 8
  %40 = load i32, i32* %7, align 4
  %41 = sext i32 %40 to i64
  %42 = getelementptr inbounds [60 x i32], [60 x i32]* %39, i64 %41
...
49:                                               ; preds = %22
  %50 = load [60 x i32]*, [60 x i32]** %4, align 8
  %51 = load i32, i32* %5, align 4
  %52 = sext i32 %51 to i64
  %53 = getelementptr inbounds [60 x i32], [60 x i32]* %50, i64 %52
...
58:                                               ; preds = %22
  %59 = load [60 x i32]*, [60 x i32]** %4, align 8
  %60 = load i32, i32* %5, align 4
  %61 = sext i32 %60 to i64
  %62 = getelementptr inbounds [60 x i32], [60 x i32]* %59, i64 %61
  %63 = load i32, i32* %7, align 4
  %64 = sext i32 %63 to i64
  %65 = getelementptr inbounds [60 x i32], [60 x i32]* %62, i64 0, i64 %64
  %66 = load i32, i32* %65, align 4
  %67 = load [60 x i32]*, [60 x i32]** %4, align 8
  %68 = load i32, i32* %7, align 4
  %69 = sext i32 %68 to i64
  %70 = getelementptr inbounds [60 x i32], [60 x i32]* %67, i64 %69
  %71 = load i32, i32* %6, align 4
  %72 = sext i32 %71 to i64
  %73 = getelementptr inbounds [60 x i32], [60 x i32]* %70, i64 0, i64 %72
...
76:                                               ; preds = %58, %49
  ...
  %78 = load [60 x i32]*, [60 x i32]** %4, align 8
  %79 = load i32, i32* %5, align 4
  %80 = sext i32 %79 to i64
  %81 = getelementptr inbounds [60 x i32], [60 x i32]* %78, i64 %80
...
31:                                               ; preds = %28, %20
  ...
  %33 = load [60 x i32]*, [60 x i32]** %4, align 8
  %34 = load i32, i32* %5, align 4
  %35 = sext i32 %34 to i64
  %36 = getelementptr inbounds [60 x i32], [60 x i32]* %33, i64 %35
  %37 = load i32, i32* %6, align 4
  %38 = sext i32 %37 to i64
  %39 = getelementptr inbounds [60 x i32], [60 x i32]* %36, i64 0, i64 %38
  %40 = load i32, i32* %39, align 4
  %41 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %32, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0), i32 %40)
  br label %42
