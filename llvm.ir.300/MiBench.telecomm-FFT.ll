...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @NumberOfBitsNeeded(i32 %0) #0 {
  %2 = alloca i32, align 4
  %3 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
...
6:                                                ; preds = %1
  ...
  %9 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %7, i8* getelementptr inbounds ([73 x i8], [73 x i8]* @.str, i64 0, i64 0), i32 %8)
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @ReverseBits(i32 %0, i32 %1) #0 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define dso_local double @Index_to_frequency(i32 %0, i32 %1) #0 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @fft_float(i32 %0, i32 %1, float* %2, float* %3, float* %4, float* %5) #0 {
...
36:                                               ; preds = %6
  ...
  %39 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %37, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.1, i64 0, i64 0), i32 %38)
  call void @exit(i32 1) #5
  unreachable
...
46:                                               ; preds = %43, %40
  ...
  call void @CheckPointer(i8* %48, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1.2, i64 0, i64 0))
  %49 = load float*, float** %11, align 8
  %50 = bitcast float* %49 to i8*
  call void @CheckPointer(i8* %50, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0))
  %51 = load float*, float** %12, align 8
  %52 = bitcast float* %51 to i8*
  call void @CheckPointer(i8* %52, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.3, i64 0, i64 0))
...
97:                                               ; preds = %93
  ...
  %104 = call double @sin(double %103) #6
...
; Function Attrs: noinline nounwind uwtable
define internal void @CheckPointer(i8* %0, i8* %1) #0 {
  %3 = alloca i8*, align 8
  %4 = alloca i8*, align 8
...
7:                                                ; preds = %2
  ...
  %10 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %8, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.4, i64 0, i64 0), i8* %9)
  call void @exit(i32 1) #5
  unreachable
...
19:                                               ; preds = %2
  %20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.5, i64 0, i64 0))
  %21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1.6, i64 0, i64 0))
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.2.7, i64 0, i64 0))
  %23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.3.8, i64 0, i64 0))
  call void @exit(i32 -1) #5
  unreachable
...
27:                                               ; preds = %24
  ...
  %31 = call i32 @strncmp(i8* %30, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4.9, i64 0, i64 0), i64 2) #7
  %32 = icmp ne i32 %31, 0
  %33 = xor i1 %32, true
...
115:                                              ; preds = %111
  ...
  %131 = call double @cos(double %130) #6
...
141:                                              ; preds = %111
  ...
  %157 = call double @sin(double %156) #6
...
179:                                              ; preds = %98
  ...
  call void @fft_float(i32 %180, i32 %181, float* %182, float* %183, float* %184, float* %185)
  %186 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.5.10, i64 0, i64 0))
  store i32 0, i32* %8, align 4
  br label %187
...
191:                                              ; preds = %187
  ...
  %198 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i64 0, i64 0), double %197)
  br label %199
...
202:                                              ; preds = %187
  %203 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i64 0, i64 0))
  %204 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.8, i64 0, i64 0))
  store i32 0, i32* %8, align 4
  br label %205
...
209:                                              ; preds = %205
  ...
  %216 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i64 0, i64 0), double %215)
  br label %217
...
220:                                              ; preds = %205
  %221 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i64 0, i64 0))
