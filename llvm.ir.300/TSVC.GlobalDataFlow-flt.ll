...
23:                                               ; preds = %20
  ...
  %35 = load float, float* %34, align 4
  %36 = load float, float* getelementptr inbounds (float, float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 256048) to float*), i64 1), align 4
  %37 = fmul float %35, %36
  %38 = fadd float %31, %37
  %39 = load i32, i32* %6, align 4
...
48:                                               ; preds = %20
  %49 = call i32 @dummy(float* getelementptr inbounds (%struct.GlobalData, %struct.GlobalData* @global_data, i32 0, i32 0, i32 0), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 128016) to float*), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 256048) to float*), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 384080) to float*), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 512128) to float*), [256 x float]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 640192) to [256 x float]*), [256 x float]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 902416) to [256 x float]*), [256 x float]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 1164640) to [256 x float]*), float 0.000000e+00)
  br label %50
...
36:                                               ; preds = %33
  ...
  %45 = sext i32 %44 to i64
  %46 = getelementptr inbounds [65536 x float], [65536 x float]* @array, i64 0, i64 %45
  %47 = load float, float* %46, align 4
  %48 = fadd float %47, %43
...
12:                                               ; preds = %7
  %13 = call i32 @s151s(float* getelementptr inbounds (%struct.GlobalData, %struct.GlobalData* @global_data, i32 0, i32 0, i32 0), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 128016) to float*), i32 1)
  %14 = call i32 @dummy(float* getelementptr inbounds (%struct.GlobalData, %struct.GlobalData* @global_data, i32 0, i32 0, i32 0), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 128016) to float*), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 256048) to float*), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 384080) to float*), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 512128) to float*), [256 x float]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 640192) to [256 x float]*), [256 x float]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 902416) to [256 x float]*), [256 x float]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 1164640) to [256 x float]*), float 0.000000e+00)
  br label %15
...
16:                                               ; preds = %13
  ...
  %30 = call i32 @s152s(float* getelementptr inbounds (%struct.GlobalData, %struct.GlobalData* @global_data, i32 0, i32 0, i32 0), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 128016) to float*), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 256048) to float*), i32 %29)
  br label %31
...
17:                                               ; preds = %14
  ...
  %27 = call float @cosf(float %26) #5
  %28 = fadd float %22, %27
  %29 = load i32, i32* %6, align 4
  %30 = sext i32 %29 to i64
  %31 = getelementptr inbounds float, float* getelementptr inbounds (%struct.GlobalData, %struct.GlobalData* @global_data, i32 0, i32 0, i32 0), i64 %30
...
35:                                               ; preds = %14
  %36 = call i32 @dummy(float* getelementptr inbounds (%struct.GlobalData, %struct.GlobalData* @global_data, i32 0, i32 0, i32 0), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 128016) to float*), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 256048) to float*), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 384080) to float*), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 512128) to float*), [256 x float]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 640192) to [256 x float]*), [256 x float]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 902416) to [256 x float]*), [256 x float]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 1164640) to [256 x float]*), float 0.000000e+00)
  br label %37
...
17:                                               ; preds = %14
  ...
  %24 = getelementptr inbounds float, float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 256048) to float*), i64 %23
...
21:                                               ; preds = %17
  ...
  %37 = sext i32 %36 to i64
  %38 = getelementptr inbounds [32000 x float], [32000 x float]* @x, i64 0, i64 %37
  store float %35, float* %38, align 4
  %39 = call i32 @s471s()
  %40 = load i32, i32* %7, align 4
  %41 = sext i32 %40 to i64
  ...
  %56 = getelementptr inbounds float, float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 128016) to float*), i64 %55
...
77:                                               ; preds = %74
  ...
  %80 = getelementptr inbounds [32000 x float], [32000 x float]* @x, i64 0, i64 %79
  %81 = load float, float* %80, align 4
  %82 = load float, float* @temp, align 4
  %83 = fadd float %82, %81
...
16:                                               ; preds = %13
  ...
  %24 = load float, float* %23, align 4
  %25 = call float @f(float %20, float %24)
  %26 = load i32, i32* %6, align 4
  %27 = sext i32 %26 to i64
...
; Function Attrs: noinline nounwind uwtable
define internal float @f(float %0, float %1) #0 {
  %3 = alloca float, align 4
  %4 = alloca float, align 4
