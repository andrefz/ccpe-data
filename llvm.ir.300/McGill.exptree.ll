...
11:                                               ; preds = %10, %0
  ...
  %14 = load i32, i32* @listLength, align 4
  %15 = sext i32 %14 to i64
  %16 = getelementptr inbounds [16 x i32], [16 x i32]* %1, i64 0, i64 %15
  %17 = load i32, i32* %16, align 4
  store i32 %17, i32* @goal, align 4
  %18 = load i32, i32* @listLength, align 4
  %19 = mul nsw i32 2, %18
  %20 = call i32* @newWorkList(i32 %19)
  store i32* %20, i32** @workList, align 8
  %21 = load i32, i32* @listLength, align 4
  %22 = call %struct.Comb* @newCombList(i32 %21)
  store %struct.Comb* %22, %struct.Comb** @combList, align 8
  %23 = load i32, i32* @listLength, align 4
  %24 = call %struct.Comb* @newCombList(i32 %23)
  store %struct.Comb* %24, %struct.Comb** @solution, align 8
  %25 = load i32*, i32** @workList, align 8
  %26 = getelementptr inbounds [16 x i32], [16 x i32]* %1, i64 0, i64 0
  %27 = load i32, i32* @listLength, align 4
  call void @initWorkList(i32* %25, i32* %26, i32 %27)
  %28 = load %struct.Comb*, %struct.Comb** @combList, align 8
  %29 = load i32, i32* @listLength, align 4
  call void @initCombList(%struct.Comb* %28, i32 %29)
  %30 = load %struct.Comb*, %struct.Comb** @solution, align 8
  %31 = load i32, i32* @listLength, align 4
  call void @initCombList(%struct.Comb* %30, i32 %31)
