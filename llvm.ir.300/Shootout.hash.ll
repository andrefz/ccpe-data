...
define dso_local %struct.ht_node* @ht_node_create(i8* %0) #0 {
  %2 = alloca i8*, align 8
  %3 = alloca i8*, align 8
...
8:                                                ; preds = %1
  call void @perror(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0))
  call void @exit(i32 1) #6
  unreachable

9:                                                ; preds = %1
  %10 = load i8*, i8** %2, align 8
  %11 = call noalias i8* @strdup(i8* %10) #5
  store i8* %11, i8** %3, align 8
  %12 = icmp eq i8* %11, null
  br i1 %12, label %13, label %14

13:                                               ; preds = %9
  call void @perror(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i64 0, i64 0))
  call void @exit(i32 1) #6
  unreachable
...
; Function Attrs: noinline nounwind uwtable
define dso_local %struct.ht_ht* @ht_create(i32 %0) #0 {
...
18:                                               ; preds = %7
  ...
  %30 = call noalias i8* @calloc(i64 %29, i64 8) #5
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @ht_destroy(%struct.ht_ht* %0) #0 {
...
19:                                               ; preds = %18, %13
  ...
  %22 = call %struct.ht_ht* @ht_create(i32 %21)
...
27:                                               ; preds = %23
  ...
  %30 = call i32 (i8*, i8*, ...) @sprintf(i8* %28, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32 %29) #5
  %31 = load i32, i32* %6, align 4
  %32 = load %struct.ht_ht*, %struct.ht_ht** %10, align 8
  %33 = getelementptr inbounds [32 x i8], [32 x i8]* %9, i64 0, i64 0
  %34 = call %struct.ht_node* @ht_find_new(%struct.ht_ht* %32, i8* %33)
...
44:                                               ; preds = %41
  ...
  %47 = call i32 (i8*, i8*, ...) @sprintf(i8* %45, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i32 %46) #5
  %48 = load %struct.ht_ht*, %struct.ht_ht** %10, align 8
  %49 = getelementptr inbounds [32 x i8], [32 x i8]* %9, i64 0, i64 0
  %50 = call %struct.ht_node* @ht_find(%struct.ht_ht* %48, i8* %49)
...
59:                                               ; preds = %41
  ...
  call void @ht_destroy(%struct.ht_ht* %60)
  %61 = load i32, i32* %7, align 4
  %62 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i64 0, i64 0), i32 %61)
  ret i32 0
}
...
; Function Attrs: noinline nounwind uwtable
define internal %struct.ht_node* @ht_find_new(%struct.ht_ht* %0, i8* %1) #0 {
  %3 = alloca %struct.ht_node*, align 8
  %4 = alloca %struct.ht_ht*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i32, align 4
  ...
  %11 = call i32 @ht_hashcode(%struct.ht_ht* %9, i8* %10)
...
22:                                               ; preds = %19
  ...
  %27 = call i32 @strcmp(i8* %23, i8* %26) #7
  %28 = icmp eq i32 %27, 0
...
48:                                               ; preds = %36
  ...
  %50 = call %struct.ht_node* @ht_node_create(i8* %49)
...
; Function Attrs: noinline nounwind uwtable
define internal %struct.ht_node* @ht_find(%struct.ht_ht* %0, i8* %1) #0 {
  %3 = alloca %struct.ht_node*, align 8
  %4 = alloca %struct.ht_ht*, align 8
  %5 = alloca i8*, align 8
  %6 = alloca i32, align 4
  ...
  %10 = call i32 @ht_hashcode(%struct.ht_ht* %8, i8* %9)
...
21:                                               ; preds = %18
  ...
  %26 = call i32 @strcmp(i8* %22, i8* %25) #7
  %27 = icmp eq i32 %26, 0
...
; Function Attrs: noinline nounwind uwtable
define internal i32 @ht_hashcode(%struct.ht_ht* %0, i8* %1) #0 {
