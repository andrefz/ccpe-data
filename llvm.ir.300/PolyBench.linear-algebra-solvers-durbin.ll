...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  ...
  %9 = call i8* @polybench_alloc_data(i64 40, i32 8)
  %10 = bitcast i8* %9 to [40 x double]*
  store [40 x double]* %10, [40 x double]** %7, align 8
  %11 = call i8* @polybench_alloc_data(i64 40, i32 8)
  %12 = bitcast i8* %11 to [40 x double]*
  store [40 x double]* %12, [40 x double]** %8, align 8
  %13 = load i32, i32* %6, align 4
  %14 = load [40 x double]*, [40 x double]** %7, align 8
  %15 = getelementptr inbounds [40 x double], [40 x double]* %14, i64 0, i64 0
  call void @init_array(i32 %13, double* %15)
  %16 = load i32, i32* %6, align 4
  %17 = load [40 x double]*, [40 x double]** %7, align 8
  %18 = getelementptr inbounds [40 x double], [40 x double]* %17, i64 0, i64 0
  ...
  call void @print_array(i32 %21, double* %23)
  %24 = load [40 x double]*, [40 x double]** %7, align 8
  %25 = bitcast [40 x double]* %24 to i8*
  call void @free(i8* %25) #4
  %26 = load [40 x double]*, [40 x double]** %8, align 8
  %27 = bitcast [40 x double]* %26 to i8*
  call void @free(i8* %27) #4
  ret i32 0
}

; Function Attrs: noinline nounwind uwtable
define internal void @init_array(i32 %0, double* %1) #0 {
  %3 = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_durbin(i32 %0, double* %1, double* %2) #0 {
  %4 = alloca i32, align 4
