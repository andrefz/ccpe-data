...
33:                                               ; preds = %8
  ...
  %41 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.137, i64 0, i64 0), double %40)
...
39:                                               ; preds = %10
  ...
  %46 = load double, double* %6, align 8
  %47 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.138, i64 0, i64 0), double %46)
  call void @check(i32 1)
  ret i32 0
}
...
39:                                               ; preds = %10
  ...
  store double %45, double* %6, align 8
  %46 = load double, double* %6, align 8
  %47 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.139, i64 0, i64 0), double %46)
  call void @check(i32 1)
  ret i32 0
}
...
39:                                               ; preds = %8
  ...
  %47 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.140, i64 0, i64 0), double %46)
  call void @check(i32 1)
  ret i32 0
}
...
35:                                               ; preds = %8
  ...
  %43 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.141, i64 0, i64 0), double %42)
  call void @check(i32 1)
  ret i32 0
}
...
35:                                               ; preds = %8
  ...
  store double %41, double* %4, align 8
  %42 = load double, double* %4, align 8
  %43 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.142, i64 0, i64 0), double %42)
  call void @check(i32 1)
  ret i32 0
}
...
40:                                               ; preds = %8
  ...
  %48 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.143, i64 0, i64 0), double %47)
  call void @check(i32 1)
  ret i32 0
}

; Function Attrs: noinline nounwind uwtable
define dso_local i32 @vpvts(double %0) #0 {
  %2 = alloca double, align 8
  %3 = alloca i64, align 8
  %4 = alloca i64, align 8
  %5 = alloca i64, align 8
...
38:                                               ; preds = %10
  ...
  %46 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.144, i64 0, i64 0), double %45)
  call void @check(i32 1)
  ret i32 0
}
...
40:                                               ; preds = %8
  ...
  store double %46, double* %4, align 8
  %47 = load double, double* %4, align 8
  %48 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.145, i64 0, i64 0), double %47)
  call void @check(i32 1)
  ret i32 0
}
...
43:                                               ; preds = %8
  ...
  %51 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.146, i64 0, i64 0), double %50)
  call void @check(i32 1)
  ret i32 0
}
...
34:                                               ; preds = %9
  ...
  %42 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.147, i64 0, i64 0), double %41)
  call void @check(i32 1)
  ret i32 0
}
...
39:                                               ; preds = %9
  ...
  store double %45, double* %4, align 8
  %46 = load double, double* %4, align 8
  %47 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.148, i64 0, i64 0), double %46)
...
23:                                               ; preds = %20
  ...
  %42 = getelementptr inbounds double, double* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 1024160) to double*), i64 %41
  %43 = load double, double* %42, align 8
  store double %43, double* %9, align 8
  %44 = load i32, i32* %12, align 4
  %45 = sext i32 %44 to i64
  %46 = getelementptr inbounds [256 x double], [256 x double]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 1280224) to [256 x double]*), i64 0, i64 %45
  %47 = load double, double* %46, align 8
  ...
  %173 = getelementptr inbounds [32000 x double], [32000 x double]* @x, i64 0, i64 %172
...
177:                                              ; preds = %20
  %178 = call i32 @dummy(double* getelementptr inbounds (%struct.GlobalData, %struct.GlobalData* @global_data, i32 0, i32 0, i32 0), double* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 256032) to double*), double* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 512064) to double*), double* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 768096) to double*), double* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 1024160) to double*), [256 x double]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 1280224) to [256 x double]*), [256 x double]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 1804608) to [256 x double]*), [256 x double]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 2328992) to [256 x double]*), double 0.000000e+00)
  br label %179
...
182:                                              ; preds = %15
  ...
  %190 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.149, i64 0, i64 0), double %189)
...
191:                                              ; preds = %201, %182
  ...
  %193 = icmp slt i32 %192, 32000
  br i1 %193, label %194, label %204

194:                                              ; preds = %191
  %195 = load i32, i32* %13, align 4
  %196 = sext i32 %195 to i64
  %197 = getelementptr inbounds [32000 x double], [32000 x double]* @x, i64 0, i64 %196
  %198 = load double, double* %197, align 8
  %199 = load double, double* @temp, align 8
  %200 = fadd double %199, %198
  store double %200, double* @temp, align 8
  br label %201
...
define dso_local void @set(i32* %0, double* %1, double* %2) #0 {
  ...
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.150, i64 0, i64 0))
  store i32 0, i32* %7, align 4
  br label %11
...
20:                                               ; preds = %15, %2
  ...
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.151, i64 0, i64 0), i32 %21)
...
30:                                               ; preds = %25, %20
  ...
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.152, i64 0, i64 0))
  %33 = call i32 @va()
  %34 = load i32*, i32** %8, align 8
  %35 = call i32 @vag(i32* %34)
  %36 = load i32*, i32** %8, align 8
  %37 = call i32 @vas(i32* %36)
  %38 = call i32 @vif()
  %39 = call i32 @vpv()
  %40 = call i32 @vtv()
  %41 = call i32 @vpvtv()
  %42 = load double, double* %9, align 8
  %43 = call i32 @vpvts(double %42)
  %44 = call i32 @vpvpv()
  %45 = call i32 @vtvtv()
  %46 = call i32 @vsumr()
  %47 = call i32 @vdotr()
