...
16:                                               ; preds = %11
  %17 = load float*, float** @xx, align 8
  store float* %17, float** @yy, align 8
...
21:                                               ; preds = %18
  %22 = load float*, float** @yy, align 8
...
define dso_local i32 @s1421() #0 {
  ...
  %10 = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.101, i64 0, i64 0))
  store i64 0, i64* %1, align 8
  store float* getelementptr inbounds (float, float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 128016) to float*), i64 16000), float** @xx, align 8
  store i32 0, i32* %5, align 4
  br label %11
...
20:                                               ; preds = %17
  %21 = load float*, float** @xx, align 8
...
20:                                               ; preds = %17
  ...
  %22 = add nsw i32 %21, 8
  %23 = sext i32 %22 to i64
  %24 = getelementptr inbounds [65536 x float], [65536 x float]* @array, i64 0, i64 %23
  %25 = load float, float* %24, align 4
  %26 = load i32, i32* %6, align 4
  %27 = sext i32 %26 to i64
  %28 = getelementptr inbounds float, float* getelementptr inbounds (%struct.GlobalData, %struct.GlobalData* @global_data, i32 0, i32 0, i32 0), i64 %27
  %29 = load float, float* %28, align 4
  %30 = fadd float %25, %29
  %31 = load float*, float** @xx, align 8
  %32 = load i32, i32* %6, align 4
  %33 = sext i32 %32 to i64
...
24:                                               ; preds = %21
  %25 = load float*, float** @xx, align 8
...
24:                                               ; preds = %21
  ...
  %33 = fadd float %28, %32
  %34 = load float*, float** @xx, align 8
  %35 = load i32, i32* %7, align 4
  %36 = add nsw i32 %35, 1
  %37 = sext i32 %36 to i64
