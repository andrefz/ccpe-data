...
@i_ub = common dso_local global i32 0, align 4
@x_size = common dso_local global i32 0, align 4
...
@i_lb = common dso_local global i32 0, align 4
...
@.str.4 = private unnamed_addr constant [10 x i8] c"rmatmult3\00", align 1
@.str.7 = private unnamed_addr constant [2 x i8] c"r\00", align 1
@.str.1.8 = private unnamed_addr constant [14 x i8] c"***** ERROR \0A\00", align 1
@.str.2.9 = private unnamed_addr constant [34 x i8] c"      Cannot open input file: %s\0A\00", align 1
@.str.3.10 = private unnamed_addr constant [24 x i8] c"%d %d %d %d %d %d %d %d\00", align 1
@.str.4.11 = private unnamed_addr constant [15 x i8] c"***** input  \0A\00", align 1
...
@.str.7.12 = private unnamed_addr constant [22 x i8] c"***** array bounds  \0A\00", align 1
...
define dso_local i32 @main(i32 %0, i8** %1) #0 {
  ...
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str, i64 0, i64 0))
...
21:                                               ; preds = %2
  ...
  %25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i64 0, i64 0), i8* %24)
...
56:                                               ; preds = %45
  %57 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0))
  store i32 0, i32* %16, align 4
  br label %58
...
62:                                               ; preds = %58
  ...
  %69 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.3, i64 0, i64 0), i32 %63, double %68)
  br label %70
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @rmatmult3(%struct.Domain_s* %0, %struct.RadiationData_t* %1, double* %2, double* %3) #0 {
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @readInput(i8* %0) #0 {
  %2 = alloca i8*, align 8
  %3 = alloca %struct._IO_FILE*, align 8
  store i8* %0, i8** %2, align 8
  %4 = load i8*, i8** %2, align 8
  %5 = call %struct._IO_FILE* @fopen(i8* %4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i64 0, i64 0))
  store %struct._IO_FILE* %5, %struct._IO_FILE** %3, align 8
  %6 = icmp eq %struct._IO_FILE* %5, null
  br i1 %6, label %7, label %11

7:                                                ; preds = %1
  %8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1.8, i64 0, i64 0))
  %9 = load i8*, i8** %2, align 8
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.2.9, i64 0, i64 0), i8* %9)
  call void @exit(i32 1) #5
  unreachable

11:                                               ; preds = %1
  %12 = load %struct._IO_FILE*, %struct._IO_FILE** %3, align 8
  %13 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %12, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.3.10, i64 0, i64 0), i32* @kmin, i32* @kmax, i32* @jmin, i32* @jmax, i32* @imin, i32* @imax, i32* @kp, i32* @jp)
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4.11, i64 0, i64 0))
  %15 = load i32, i32* @kmin, align 4
  %16 = load i32, i32* @kmax, align 4
  %17 = load i32, i32* @jmin, align 4
  %18 = load i32, i32* @jmax, align 4
  %19 = load i32, i32* @imin, align 4
  %20 = load i32, i32* @imax, align 4
  %21 = load i32, i32* @kp, align 4
  %22 = load i32, i32* @jp, align 4
  %23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([113 x i8], [113 x i8]* @.str.5, i64 0, i64 0), i32 %15, i32 %16, i32 %17, i32 %18, i32 %19, i32 %20, i32 %21, i32 %22)
  %24 = load i32, i32* @imin, align 4
  %25 = load i32, i32* @jmin, align 4
  %26 = load i32, i32* @jp, align 4
  %27 = mul nsw i32 %25, %26
  %28 = add nsw i32 %24, %27
  %29 = load i32, i32* @kmin, align 4
  %30 = load i32, i32* @kp, align 4
  %31 = mul nsw i32 %29, %30
  %32 = add nsw i32 %28, %31
  store i32 %32, i32* @i_lb, align 4
  %33 = load i32, i32* @imax, align 4
  %34 = sub nsw i32 %33, 1
  %35 = load i32, i32* @jmax, align 4
  %36 = sub nsw i32 %35, 1
  %37 = load i32, i32* @jp, align 4
  %38 = mul nsw i32 %36, %37
  %39 = add nsw i32 %34, %38
  %40 = load i32, i32* @kmax, align 4
  %41 = sub nsw i32 %40, 1
  %42 = load i32, i32* @kp, align 4
  %43 = mul nsw i32 %41, %42
  %44 = add nsw i32 %39, %43
  %45 = add nsw i32 %44, 1
  store i32 %45, i32* @i_ub, align 4
  %46 = load i32, i32* @i_lb, align 4
  %47 = load i32, i32* @kp, align 4
  %48 = sub nsw i32 %46, %47
  %49 = load i32, i32* @jp, align 4
...
53:                                               ; preds = %11
  %54 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1.8, i64 0, i64 0))
  %55 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.6, i64 0, i64 0))
  call void @exit(i32 1) #5
  unreachable

56:                                               ; preds = %11
  %57 = load i32, i32* @i_ub, align 4
  %58 = load i32, i32* @kp, align 4
  %59 = load i32, i32* @jp, align 4
  %60 = add nsw i32 %58, %59
  %61 = add nsw i32 %60, 1
  %62 = mul nsw i32 2, %61
  %63 = add nsw i32 %57, %62
  %64 = add nsw i32 %63, 10
  store i32 %64, i32* @x_size, align 4
  %65 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.7.12, i64 0, i64 0))
  %66 = load i32, i32* @i_lb, align 4
  %67 = load i32, i32* @i_ub, align 4
  %68 = load i32, i32* @x_size, align 4
  %69 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.8, i64 0, i64 0), i32 %66, i32 %67, i32 %68)
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @allocMem(%struct.RadiationData_t* %0) #0 {
  ...
  %106 = call noalias i8* @malloc(i64 %105) #4
  ...
  %112 = call noalias i8* @malloc(i64 %111) #4
  ...
  %118 = call noalias i8* @malloc(i64 %117) #4
  ...
  %124 = call noalias i8* @malloc(i64 %123) #4
  ...
  %130 = call noalias i8* @malloc(i64 %129) #4
  ...
  %136 = call noalias i8* @malloc(i64 %135) #4
  ...
  %154 = call noalias i8* @malloc(i64 %153) #4
  ...
  %160 = call noalias i8* @malloc(i64 %159) #4
  ...
  %166 = call noalias i8* @malloc(i64 %165) #4
...
174:                                              ; preds = %1
  %175 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.9, i64 0, i64 0))
  br label %176
...
; Function Attrs: noinline nounwind uwtable
define dso_local void @init(%struct.Domain_s* %0, %struct.RadiationData_t* %1, double* %2, double* %3) #0 {
  %5 = alloca %struct.Domain_s*, align 8
  %6 = alloca %struct.RadiationData_t*, align 8
  %7 = alloca double*, align 8
  %8 = alloca double*, align 8
