...
3:                                                ; preds = %13, %0
  %4 = call i64 @read(i32 0, i8* getelementptr inbounds ([500 x i8], [500 x i8]* @abuf, i64 0, i64 0), i64 500)
...
8:                                                ; preds = %3
  call void @perror(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0))
...
13:                                               ; preds = %9
  ...
  %15 = mul nsw i32 %14, 2
  call void @adpcm_decoder(i8* getelementptr inbounds ([500 x i8], [500 x i8]* @abuf, i64 0, i64 0), i16* getelementptr inbounds ([1000 x i16], [1000 x i16]* @sbuf, i64 0, i64 0), i32 %15, %struct.adpcm_state* @state)
  %16 = load i32, i32* %2, align 4
  %17 = mul nsw i32 %16, 4
  %18 = sext i32 %17 to i64
  %19 = call i64 @write(i32 1, i8* bitcast ([1000 x i16]* @sbuf to i8*), i64 %18)
  br label %3
...
20:                                               ; preds = %12
  ...
  %26 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %21, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.1, i64 0, i64 0), i32 %23, i32 %25)
