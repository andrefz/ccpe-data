...
37:                                               ; preds = %18
  ...
  %39 = call i32 @ferror(%struct._IO_FILE* %38) #4
  %40 = icmp ne i32 %39, 0
...
13:                                               ; preds = %9
  ...
  %25 = call i8* @mybasename(i8* %24)
  %26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i64 0, i64 0), i32 %21, i64 %22, i8* %25)
  br label %9
...
define internal i8* @mybasename(i8* %0) #0 {
  ...
  %5 = call i8* @strrchr(i8* %4, i32 47) #5
