...
30:                                               ; preds = %15
  ...
  %34 = call i32 @dummy(double* getelementptr inbounds (%struct.GlobalData, %struct.GlobalData* @global_data, i32 0, i32 0, i32 0), double* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 256032) to double*), double* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 512064) to double*), double* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 768096) to double*), double* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 1024160) to double*), [256 x double]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 1280224) to [256 x double]*), [256 x double]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 1804608) to [256 x double]*), [256 x double]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 2328992) to [256 x double]*), double %33)
  br label %35
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @s332(double %0) #0 {
  %2 = alloca double, align 8
  %3 = alloca i64, align 8
...
39:                                               ; preds = %38, %28
  ...
  %45 = call i32 @dummy(double* getelementptr inbounds (%struct.GlobalData, %struct.GlobalData* @global_data, i32 0, i32 0, i32 0), double* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 256032) to double*), double* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 512064) to double*), double* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 768096) to double*), double* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 1024160) to double*), [256 x double]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 1280224) to [256 x double]*), [256 x double]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 1804608) to [256 x double]*), [256 x double]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 2328992) to [256 x double]*), double %44)
  br label %46
...
49:                                               ; preds = %13
  ...
  store double %58, double* @temp, align 8
  call void @check(i32 -1)
  ret i32 0
}
...
define dso_local void @set(i32* %0, double* %1, double* %2) #0 {
  ...
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.139, i64 0, i64 0))
  store i32 0, i32* %7, align 4
  br label %11
...
20:                                               ; preds = %15, %2
  ...
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.140, i64 0, i64 0), i32 %21)
...
30:                                               ; preds = %25, %20
  ...
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.141, i64 0, i64 0))
  %33 = call i32 @s331()
  %34 = load double, double* %9, align 8
  %35 = call i32 @s332(double %34)
  ret i32 0
}
