...
48:                                               ; preds = %10
  ...
  %56 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.137, i64 0, i64 0), double %55)
...
39:                                               ; preds = %17
  %40 = call i32 @dummy(float* getelementptr inbounds (%struct.GlobalData, %struct.GlobalData* @global_data, i32 0, i32 0, i32 0), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 128016) to float*), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 256048) to float*), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 384080) to float*), float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 512128) to float*), [256 x float]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 640192) to [256 x float]*), [256 x float]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 902416) to [256 x float]*), [256 x float]* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 1164640) to [256 x float]*), float 0.000000e+00)
  br label %41
...
44:                                               ; preds = %12
  ...
  %52 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.138, i64 0, i64 0), double %51)
  call void @check(i32 1)
  ret i32 0
}
...
47:                                               ; preds = %10
  ...
  %55 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.139, i64 0, i64 0), double %54)
  call void @check(i32 1)
  ret i32 0
}
...
59:                                               ; preds = %13
  ...
  %67 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.140, i64 0, i64 0), double %66)
  call void @check(i32 1)
  ret i32 0
}
...
43:                                               ; preds = %11
  ...
  %51 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.141, i64 0, i64 0), double %50)
  %52 = load float, float* %7, align 4
  store float %52, float* @temp, align 4
  call void @check(i32 -1)
  ret i32 0
}
...
16:                                               ; preds = %53, %3
  ...
  %18 = load i32, i32* @ntimes, align 4
...
25:                                               ; preds = %22
  ...
  %43 = getelementptr inbounds [256 x float], [256 x float]* %36, i64 0, i64 %42
...
56:                                               ; preds = %16
  ...
  %64 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.142, i64 0, i64 0), double %63)
...
43:                                               ; preds = %8
  ...
  %51 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.143, i64 0, i64 0), double %50)
  call void @check(i32 1)
  ret i32 0
}
...
define dso_local void @set(i32* %0, float* %1, float* %2) #0 {
  ...
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.144, i64 0, i64 0))
  store i32 0, i32* %7, align 4
  br label %11
...
20:                                               ; preds = %15, %2
  ...
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.145, i64 0, i64 0), i32 %21)
...
30:                                               ; preds = %25, %20
  ...
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.146, i64 0, i64 0))
  %33 = load i32*, i32** %8, align 8
  %34 = call i32 @s491(i32* %33)
  %35 = load i32*, i32** %8, align 8
  %36 = load float, float* %9, align 4
  %37 = call i32 @s4112(i32* %35, float %36)
  %38 = load i32*, i32** %8, align 8
  %39 = call i32 @s4113(i32* %38)
  %40 = load i32*, i32** %8, align 8
  %41 = load i32, i32* %6, align 4
  %42 = call i32 @s4114(i32* %40, i32 %41)
  %43 = load i32*, i32** %8, align 8
  %44 = call i32 @s4115(i32* %43)
  %45 = load i32*, i32** %8, align 8
  %46 = load i32, i32* %6, align 4
  %47 = call i32 @s4116(i32* %45, i32 128, i32 %46)
  %48 = call i32 @s4117()
  ret i32 0
}
