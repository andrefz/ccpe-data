...
3:                                                ; preds = %13, %0
  %4 = call i64 @read(i32 0, i8* bitcast ([1000 x i16]* @sbuf to i8*), i64 2000)
...
13:                                               ; preds = %9
  ...
  %15 = sdiv i32 %14, 2
  call void @adpcm_coder(i16* getelementptr inbounds ([1000 x i16], [1000 x i16]* @sbuf, i64 0, i64 0), i8* getelementptr inbounds ([500 x i8], [500 x i8]* @abuf, i64 0, i64 0), i32 %15, %struct.adpcm_state* @state)
  %16 = load i32, i32* %2, align 4
  %17 = sdiv i32 %16, 4
  %18 = sext i32 %17 to i64
  %19 = call i64 @write(i32 1, i8* getelementptr inbounds ([500 x i8], [500 x i8]* @abuf, i64 0, i64 0), i64 %18)
  br label %3
