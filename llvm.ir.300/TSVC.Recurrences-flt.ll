...
40:                                               ; preds = %8
  ...
  %48 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.137, i64 0, i64 0), double %47)
...
17:                                               ; preds = %14
  ...
  %39 = sext i32 %38 to i64
  %40 = getelementptr inbounds float, float* bitcast (i8* getelementptr (i8, i8* bitcast (%struct.GlobalData* @global_data to i8*), i64 256048) to float*), i64 %39
  %41 = load float, float* %40, align 4
  %42 = fmul float %37, %41
  %43 = fadd float %32, %42
...
55:                                               ; preds = %8
  ...
  %63 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.138, i64 0, i64 0), double %62)
  call void @check(i32 1)
  ret i32 0
}
...
61:                                               ; preds = %8
  ...
  %69 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.139, i64 0, i64 0), double %68)
...
define dso_local void @set(i32* %0, float* %1, float* %2) #0 {
  ...
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.140, i64 0, i64 0))
  store i32 0, i32* %7, align 4
  br label %11
...
20:                                               ; preds = %15, %2
  ...
  %22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.141, i64 0, i64 0), i32 %21)
...
30:                                               ; preds = %25, %20
  ...
  %32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.142, i64 0, i64 0))
  %33 = call i32 @s321()
  %34 = call i32 @s322()
  %35 = call i32 @s323()
  ret i32 0
